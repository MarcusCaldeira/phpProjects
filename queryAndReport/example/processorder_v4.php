...
try {
    ...
    // YOUR CODE HERE
    $stmt = $db->prepare("INSERT INTO orders (tireqty, oilqty, sparkqty, notes, howfindbobid, date) VALUES (:tireqty, :oilqty, :sparkqty, :notes, :howfindbobid, :date)");
        $stmt->bindParam(':tireqty', $tireqty);
        $stmt->bindParam(':oilqty', $oilqty);
        $stmt->bindParam(':sparkqty', $sparkqty);
        $stmt->bindParam(':notes', $notes);
        $stmt->bindParam(':howfindbobid', $how_find_bob);
